...
#
# This file is adapted from All Atom Diffusion Transformer:
# https://github.com/facebookresearch/all-atom-diffusion-transformer
#
# The All Atom Diffusion Transformer project is licensed under CC BY-NC 4.0.
#
# Original All Atom Diffusion Transformer file was itself adapted from:
# https://github.com/NVIDIA/NeMo/blob/main/nemo/collections/common/callbacks/ema.py
#
# Copyright (c) 2022, NVIDIA CORPORATION. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 for the original NVIDIA NeMo
# portions; see the Apache-2.0 license at:
