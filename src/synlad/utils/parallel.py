"""From https://github.com/facebookresearch/all-atom-diffusion-transformer/blob/main/src/utils/joblib.py
...
class ParallelTqdm(Parallel):
    ...
    def print_progress(self):
        ...
        # Return early if progress bar is not initialized
        if self.progress_bar is None:
            return
...
def joblib_map(
    ...
    if backend != "loky" and inner_max_num_threads is not None:
        logger.warning(f"{backend=} does not support {inner_max_num_threads=}, setting to None.")
