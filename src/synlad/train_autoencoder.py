"""Adapted from https://github.com/facebookresearch/all-atom-diffusion-transformer/blob/main/src/train_autoencoder.py
...
from lightning import Callback, LightningDataModule, LightningModule, Trainer  # noqa: E402
